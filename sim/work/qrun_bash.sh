...
# UVM HOME
# UVMLIB=uvm-1.1d
# export UVM_HOME=/home/phuong/Downloads/UVM_Training/dti_uart/sim/libs/uvm-1.1d
...
TOP_TB=tb_uart_rx # name top testbench
...
alias vlgt='vlog -64 -f filelist_com.f -f filelist_vsim.f -f filelist_dtb.f -l ./log/vlogt.log'
