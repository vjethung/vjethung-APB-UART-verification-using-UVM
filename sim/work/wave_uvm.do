...
add wave -noupdate -group APB /hw_top/aif/pclk
add wave -noupdate -group APB /hw_top/aif/presetn
add wave -noupdate -group APB /hw_top/aif/paddr
add wave -noupdate -group APB /hw_top/aif/psel
add wave -noupdate -group APB /hw_top/aif/penable
add wave -noupdate -group APB /hw_top/aif/pwrite
add wave -noupdate -group APB /hw_top/aif/pstrb
add wave -noupdate -group APB /hw_top/aif/pwdata
add wave -noupdate -group APB /hw_top/aif/prdata
add wave -noupdate -group APB /hw_top/aif/pready
add wave -noupdate -group APB /hw_top/aif/pslverr
add wave -noupdate -group APB /hw_top/aif/monitor_start
add wave -noupdate -group APB /hw_top/aif/drive_start
add wave -noupdate -group UART /hw_top/uif/clk
add wave -noupdate -group UART /hw_top/uif/rst_n
add wave -noupdate -group UART /hw_top/uif/cts_n
add wave -noupdate -group UART /hw_top/uif/tx
add wave -noupdate -group UART /hw_top/uif/rx
add wave -noupdate -group UART /hw_top/uif/rts_n
add wave -noupdate -group UART /hw_top/uif/bit_period_ns
